...
import com.simon.portfoliotracker.token.TokenPricePublisher;
...
public class PortfolioTrackerApplication {
    ...
    public CommandLineRunner loadData(UserRepository userRepository,
                                      ...
                                      TokenPricePublisher tokenPricePublisher){
        return args -> {
...
//            System.out.println(userService.getUserDto("Szymon"));
            tokenPricePublisher.addObserver(webSocketBrokerService);
